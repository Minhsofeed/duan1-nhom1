            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Danh sách quản lý tài khoản</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($listAdmin as $key => $ad): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= $ad['dia_chi']; ?></td>
                                                                        <td><?= $ad['chuc_vu_id'] == 1 ? 'Admin' : 'Khách'; ?></td>
                                                                        <td><?= $ad['trang_thai'] == 1 ? 'Hoạt động' : ' Cấm'; ?></td>
                                                                        <td>
                                                                            <div class="form-check form-switch">
                                                                                <form action="index.php?act=cam-admin" method="post">
